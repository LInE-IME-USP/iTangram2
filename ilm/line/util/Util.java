...
public class Util {
  ...
  public static String getUserSystemData () {
    String dados_str = "[ "; // se for applet darï¿½ erro de "sun.applet.AppletSecurityException: checkpropsaccess.key"
    ...
    if (!ilm.line.itangram2.Tangram.isApplication()) {
      ...
      java.net.InetAddress inetaddress; // se quiser pegar tambï¿½m a mï¿½quina de quem gravou  
      try {
